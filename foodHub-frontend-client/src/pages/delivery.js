                    ...
                    <Paper className={classes.paper} elevation={2}>
                        <Grid container>
                            <Grid item sm>
                                ...
                                >
                                    Add a Delivery Account {/* Đã sửa tiêu đề nếu đây là trang đăng ký Shipper */}
                                </Typography>
                                <Typography
                                    variant="body1"
                                    component="p"
                                ...
                                <form noValidate onSubmit={handleSubmit}>
                                    <Grid container alignItems="center" spacing={1}> {/* Grid container bọc toàn bộ */}
                                        {/* ... (Các phần upload ảnh) ... */}
                                    </Grid>
                ...
                <Grid item xs={3} style={{ marginLeft: "40px" }}>
                    ...
                    >
                        ...
                        >
                            ...
                            3. Access Delivery Dashboard and go
                            &nbsp;&nbsp;&nbsp;&nbsp;live. {/* Đã sửa nội dung */}
                            <br />
                            <br />
                            <br />
                        </Typography>
